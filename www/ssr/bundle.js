var app = (function () {
	...
	function getPage() {
	    // we have access to the dynamic div in layout.html
	    // cause we included the bundle.js of dynamic.html
	    // (bundled main.js inside ssr folder which is inside www/ssr folder)
	...
	function create_main_fragment(component, ctx) {
		var input, text0, p, text1, current;
	...
	function Dynamic(options) {
		...
		if (!('boobox' in this._state)) console.warn("<Dynamic> was created without expected data property 'boobox'");

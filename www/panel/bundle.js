var app = (function () {
	...
	function create_main_fragment$c(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(h41, file$c, 22, 2, 840);
				div0.className = "row";
				addLoc(div0, file$c, 0, 0, 0);
				addLoc(h42, file$c, 80, 2, 3296);
				div1.className = "row";
				addLoc(div1, file$c, 78, 0, 3230);
			},
	...
	function create_then_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				i._fragment.c();
				addLoc(h4, file$e, 10, 20, 535);
				div0.className = "modal-content";
				addLoc(div0, file$e, 9, 16, 487);
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$e, 39, 20, 2213);
				div1.className = "modal-footer";
				addLoc(div1, file$e, 38, 16, 2166);
				...
				div2.className = "modal";
				addLoc(div2, file$e, 8, 12, 303);
				addListener(a, "click", click_handler_1);
				a.className = "btn-floating btn-large waves-effect waves-light red";
				addLoc(a, file$e, 89, 14, 5163);
				div3.className = "fixed-action-btn";
				addLoc(div3, file$e, 88, 8, 5118);
			},
	...
	function create_if_block_2$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				text5 = createText(" ?");
				addLoc(h4, file$e, 21, 28, 1118);
				addLoc(strong, file$e, 22, 70, 1213);
				addLoc(p, file$e, 22, 28, 1171);
			},
	...
	function create_if_block_1$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				text4 = createText(text4_value);
				text5 = createText(" ?");
				addLoc(h4, file$e, 17, 28, 910);
				addLoc(strong, file$e, 18, 68, 1001);
				addLoc(p, file$e, 18, 28, 961);
			},
	...
	function create_if_block$7(component, ctx) {
		...
		return {
			c: function create() {
				...
				text4 = createText(text4_value);
				text5 = createText(" ?");
				addLoc(h4, file$e, 13, 28, 700);
				addLoc(strong, file$e, 14, 69, 793);
				addLoc(p, file$e, 14, 28, 752);
			},
	...
	const file$f = "ui/panel/admin_pages/LiveChat.html";
	...
	function create_main_fragment$f(component, ctx) {
		...
		return {
			c: function create() {
				div = createElement("div");
				div.textContent = "live chat panel and its setting like disabling it.";
				addLoc(div, file$f, 2, 0, 2);
			},
	...
	function create_then_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$g, 43, 20, 2765);
				div1.className = "modal-footer";
				addLoc(div1, file$g, 42, 16, 2718);
				div2.id = div2_id_value = ctx.crudindex===1 ? "modaledit" :  ctx.crudindex===0 ? "modalcreate" : ctx.crudindex===4 ? "modalblock" : ctx.crudindex===5 ? "modalunblock" : "modaldelete";
				div2.className = "modal";
	...
	function create_if_block_3$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				a.href = "#!";
				addLoc(a, file$g, 29, 38, 1506);
				textarea.id = "content";
				textarea.className = "materialize-textarea";
				textarea.value = textarea_value_value = ctx.crudindex === 1 ? ctx.objModal.content : "";
				addLoc(textarea, file$g, 35, 40, 2349);
				label.htmlFor = "content";
				addLoc(label, file$g, 36, 40, 2495);
			},
	...
	function create_main_fragment$k(component, ctx) {
		...
		return {
			c: function create() {
				...
				info_1.block.c();
				addLoc(span0, file$k, 5, 20, 191);
				input0.id = "cover";
				setAttribute(input0, "type", "file");
				addLoc(input0, file$k, 6, 20, 229);
				div0.className = "btn waves-effect waves-light black-text red";
				...
				addLoc(input1, file$k, 9, 20, 351);
				div1.className = "file-path-wrapper";
				addLoc(div1, file$k, 8, 16, 299);
				div2.className = "file-field input-field";
				addLoc(div2, file$k, 3, 12, 60);
				label0.htmlFor = "description";
				addLoc(label0, file$k, 14, 12, 659);
				addLoc(br0, file$k, 15, 12, 724);
				div3.className = "divider";
				addLoc(div3, file$k, 15, 16, 728);
				addLoc(br1, file$k, 15, 43, 755);
				label1.htmlFor = "description";
				addLoc(label1, file$k, 18, 12, 946);
				input4.placeholder = "+Tag";
				input4.className = "custom-class";
				input4.id = "tags";
				addLoc(input4, file$k, 20, 20, 1051);
				div4.className = "chips";
				addLoc(div4, file$k, 19, 12, 1011);
				setAttribute(input5, "type", "checkbox");
				input5.id = "telegram";
				addLoc(input5, file$k, 23, 16, 1168);
				addLoc(span1, file$k, 24, 16, 1224);
				addLoc(label2, file$k, 22, 12, 1144);
				setAttribute(input6, "type", "checkbox");
				input6.id = "comments";
				addLoc(input6, file$k, 27, 16, 1311);
				addLoc(span2, file$k, 28, 16, 1366);
				addLoc(label3, file$k, 26, 12, 1287);
				form.id = "post";
				addLoc(form, file$k, 2, 9, 31);
				addLoc(br2, file$k, 37, 8, 1706);
				addListener(a, "click", click_handler);
				a.className = "waves-effect waves-light yellow black-text btn";
				addLoc(a, file$k, 37, 12, 1710);
				div5.className = "row";
				addLoc(div5, file$k, 0, 0, 0);
				addLoc(br3, file$k, 40, 0, 1805);
				div6.className = "divider";
				addLoc(div6, file$k, 40, 4, 1809);
				addLoc(br4, file$k, 40, 32, 1837);
				div7.className = "row";
				addLoc(div7, file$k, 41, 0, 1842);
			},
	...
	function create_then_block$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				div = createElement("div");
				if (if_block) if_block.c();
				addLoc(h5, file$k, 46, 12, 1956);
				addLoc(div, file$k, 48, 12, 2099);
			},
	...
	function create_if_block$9(component, ctx) {
		...
		return {
			c: function create() {
				...
				info.block.c();
				addLoc(br, file$k, 63, 16, 2847);
				addLoc(h5, file$k, 64, 16, 2868);
			},
			...
			p: function update(changed, _ctx) {
				ctx = _ctx;
				var table_changes = {};
				if (changed.utils) table_changes.actions = [
	                    {icon: "delete", tooltip: "delete", action(page, table) {
	                        ctx.utils.fetch(`/page/${page.id}/route/remove`, {})
	                        .then(r=>{
	                            if(r.status == 200) {
	...
	// (75:19)                      <Loading small/>                 {:then pages}
	...
	// (44:26)              <Loading small/>         {:then routes}
	...
	function create_main_fragment$r(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(a1, file$r, 19, 5, 562);
				addLoc(li1, file$r, 19, 1, 558);
				div1.className = "divider";
				addLoc(div1, file$r, 20, 5, 657);
				addLoc(li2, file$r, 20, 1, 653);
				addLoc(br0, file$r, 27, 1, 818);
				addLoc(br1, file$r, 27, 5, 822);
				addLoc(br2, file$r, 27, 9, 826);
				addLoc(br3, file$r, 27, 13, 830);
				ul1.id = "slide-out";
	...
	function create_if_block$e(component, ctx) {
		var li, div1, div0, text, br0, br1, br2, br3, current;

		var imgl_initial_data = { src: ctx.background, alt: "avatar" };
		var imgl = new Imgl({
			root: component.root,
			store: component.store,
			data: imgl_initial_data
		...
		return {
			c: function create() {
				...
				addLoc(br0, file$r, 15, 3, 517);
				addLoc(br1, file$r, 15, 7, 521);
				addLoc(br2, file$r, 15, 11, 525);
				addLoc(br3, file$r, 15, 15, 529);
			...
			p: function update(changed, ctx) {
				var imgl_changes = {};
				if (changed.background) imgl_changes.src = ctx.background;
				imgl._set(imgl_changes);
			},

	...
	function create_main_fragment$k(component, ctx) {
		...
		return {
			c: function create() {
				...
				info_1.block.c();
				addLoc(span0, file$k, 5, 20, 196);
				input0.id = "cover";
				setAttribute(input0, "type", "file");
				addLoc(input0, file$k, 6, 20, 235);
				...
				addLoc(input1, file$k, 9, 20, 360);
				div1.className = "file-path-wrapper";
				addLoc(div1, file$k, 8, 16, 307);
				div2.className = "file-field input-field";
				addLoc(div2, file$k, 3, 12, 63);
				label0.htmlFor = "description";
				addLoc(label0, file$k, 14, 12, 673);
				addLoc(br0, file$k, 15, 12, 739);
				div3.className = "divider";
				addLoc(div3, file$k, 15, 16, 743);
				addLoc(br1, file$k, 15, 43, 770);
				label1.htmlFor = "description";
				addLoc(label1, file$k, 18, 12, 964);
				input4.placeholder = "+Tag";
				input4.className = "custom-class";
				input4.id = "tags";
				addLoc(input4, file$k, 20, 20, 1071);
				div4.className = "chips";
				addLoc(div4, file$k, 19, 12, 1030);
				setAttribute(input5, "type", "checkbox");
				input5.id = "telegram";
				addLoc(input5, file$k, 23, 16, 1191);
				addLoc(span1, file$k, 24, 16, 1248);
				addLoc(label2, file$k, 22, 12, 1166);
				setAttribute(input6, "type", "checkbox");
				input6.id = "comments";
				addLoc(input6, file$k, 27, 16, 1338);
				addLoc(span2, file$k, 28, 16, 1394);
				addLoc(label3, file$k, 26, 12, 1313);
				form.id = "post";
				addLoc(form, file$k, 2, 9, 33);
				addLoc(br2, file$k, 37, 8, 1743);
				addListener(a, "click", click_handler);
				a.className = "waves-effect waves-light yellow black-text btn";
				addLoc(a, file$k, 37, 12, 1747);
				div5.className = "row";
				addLoc(div5, file$k, 0, 0, 0);
				addLoc(br3, file$k, 40, 0, 1845);
				div6.className = "divider";
				addLoc(div6, file$k, 40, 4, 1849);
				addLoc(br4, file$k, 40, 32, 1877);
				div7.className = "row";
				addLoc(div7, file$k, 41, 0, 1883);
			},
	...
	function create_then_block$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				div = createElement("div");
				if (if_block) if_block.c();
				addLoc(h5, file$k, 46, 12, 2002);
				addLoc(div, file$k, 48, 12, 2147);
			},
	...
	function create_if_block$9(component, ctx) {
		...
		return {
			c: function create() {
				...
				info.block.c();
				addLoc(br, file$k, 63, 16, 2910);
				addLoc(h5, file$k, 64, 16, 2932);
			},

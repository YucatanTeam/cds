var app = (function () {
	...
	/* ui/tags/Icon.html generated by Svelte v2.16.1 */

	const file = "ui/tags/Icon.html";
	...
	const file$1 = "ui/tags/Loading.html";
	...
	const file$2 = "ui/tags/Imgl.html";
	...
	const file$3 = "ui/tags/Card.html";
	...
	/* ui/tags/Modal.html generated by Svelte v2.16.1 */
	...
	const file$4 = "ui/tags/Modal.html";
	...
	function create_main_fragment$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$4, 17, 4, 622);
				div1.className = "modal-footer";
				addLoc(div1, file$4, 22, 4, 741);
				div2.id = ctx.id;
				div2.className = "modal";
				addLoc(div2, file$4, 16, 0, 588);
			},
	...
	const file$5 = "ui/tags/Input.html";
	...
	const file$6 = "ui/tags/Form.html";
	...
	function create_main_fragment$6(component, ctx) {
		...
		return {
			c: function create() {
				...
				div0 = createElement("div");
				div0.className = "row";
				addLoc(div0, file$6, 11, 8, 322);
				form.className = "col s12";
				addLoc(form, file$6, 10, 4, 291);
				div1.className = "row";
	...
	function create_main_fragment$7(component, ctx) {
		...
		return {
			c: function create() {
				...
				card2._fragment.c();
				addLoc(h40, file$7, 2, 2, 86);
				span0.className = "red-text";
				addLoc(span0, file$7, 3, 5, 147);
				span1.className = "red-text";
				addLoc(span1, file$7, 3, 72, 214);
				addLoc(p0, file$7, 3, 2, 144);
				addLoc(br0, file$7, 4, 30, 290);
				addLoc(h41, file$7, 6, 3, 369);
				addLoc(p1, file$7, 7, 3, 389);
				addListener(button0, "click", click_handler);
				button0.className = "btn white red-text waves-effect waves-gray";
				addLoc(button0, file$7, 9, 2, 581);
				div0.className = "row";
				addLoc(div0, file$7, 0, 0, 0);
				addLoc(h42, file$7, 14, 2, 760);
				span2.className = "red-text";
				addLoc(span2, file$7, 15, 5, 788);
				addLoc(br1, file$7, 15, 100, 883);
				addLoc(p2, file$7, 15, 2, 785);
				addListener(button1, "click", click_handler_1);
				button1.className = "btn waves-effect waves-light yellow black-text col s4";
				addLoc(button1, file$7, 22, 3, 1304);
				div1.className = "row";
				addLoc(div1, file$7, 12, 0, 695);
				span3.className = "red-text";
				addLoc(span3, file$7, 28, 6, 1507);
				addLoc(h43, file$7, 28, 2, 1503);
				addLoc(span4, file$7, 31, 4, 1689);
				input5.id = "avatarpicker";
				setAttribute(input5, "type", "file");
				addLoc(input5, file$7, 32, 4, 1712);
				div2.className = "btn waves-effect waves-light black-text yellow";
				addLoc(div2, file$7, 30, 3, 1624);
				input6.className = "file-path validate";
				setAttribute(input6, "type", "text");
				addLoc(input6, file$7, 35, 4, 1799);
				div3.className = "file-path-wrapper";
				addLoc(div3, file$7, 34, 3, 1763);
				div4.className = "file-field input-field";
				addLoc(div4, file$7, 29, 2, 1584);
				addListener(button2, "click", click_handler_2);
				button2.className = "btn waves-effect waves-light black-text yellow submit";
				addLoc(button2, file$7, 38, 8, 1873);
				div5.className = "row";
				addLoc(div5, file$7, 26, 0, 1438);
			},
	...
	/* ui/tags/Pagination.html generated by Svelte v2.16.1 */
	...
	const file$8 = "ui/tags/Pagination.html";
	...
	function create_else_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				text = createText(text_value);
				a.className = "yellow";
				addLoc(a, file$8, 16, 35, 521);
				li.className = "active";
				addLoc(li, file$8, 16, 16, 502);
			},
	...
	function create_if_block_1$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				a.className = "white";
				addLoc(a, file$8, 14, 41, 419);
				li.className = "waves-effect";
				addLoc(li, file$8, 14, 16, 394);
			},
	...
	/* ui/tags/Search.html generated by Svelte v2.16.1 */
	...
	const file$9 = "ui/tags/Search.html";
	...
	/* ui/tags/Table.html generated by Svelte v2.16.1 */
	...
	const file$a = "ui/tags/Table.html";
	...
	function create_main_fragment$a(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(tr, file$a, 37, 8, 1241);
				addLoc(thead, file$a, 36, 4, 1225);
				table.className = table_class_value = ctx.highlight ? "highlight" : "striped";
				addLoc(table, file$a, 35, 0, 1167);
			},
	...
	function create_else_block_2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(td, file$a, 80, 19, 2925);
				addLoc(tr, file$a, 80, 15, 2921);
				addLoc(tbody, file$a, 80, 8, 2914);
			},
	...
	const file$b = "ui/tags/RequestBtn.html";
	...
	function create_main_fragment$c(component, ctx) {
		...
		return {
			c: function create() {
				...
				form._fragment.c();
				card1._fragment.c();
				addLoc(h40, file$c, 17, 8, 551);
				addLoc(p, file$c, 18, 8, 583);
				addLoc(h41, file$c, 22, 2, 844);
				div0.className = "row";
				addLoc(div0, file$c, 0, 0, 0);
				addLoc(h42, file$c, 80, 2, 3300);
				div1.className = "row";
				addLoc(div1, file$c, 78, 0, 3234);
			},
	...
	/* ui/panel/admin_pages/FreeConsultationForm.html generated by Svelte v2.16.1 */
	...
	const file$d = "ui/panel/admin_pages/FreeConsultationForm.html";
	...
	function create_main_fragment$d(component, ctx) {
		...
		handlePromise(promise = ctx.getform, info);
		...
		return {
			...
			p: function update(changed, _ctx) {
				...
				if (('getform' in changed) && promise !== (promise = ctx.getform) && handlePromise(promise, info)) ; else {
					info.block.p(changed, assign(assign({}, ctx), info.resolved));
				}
			},
	...
	function create_catch_block$1(component, ctx) {
		...
		return {
			...
			p: function update(changed, ctx) {
				if ((changed.getform) && text1_value !== (text1_value = ctx.err.message)) {
					setData(text1, text1_value);
				}
			},
	...
	function create_then_block$1(component, ctx) {
		var div2, div0, h4, text0_value = ctx.crudindex===0 ? "Confirm Delete" : "", text0, text1, text2, div1, button, text3_value = ctx.crudindex===0 ? "Delete" : "", text3, text4, current;

		var if_block = (ctx.crudindex === 0) && create_if_block$7(component, ctx);
		...
		table.on("download", function(event) {
		...
		return {
			c: function create() {
				...
				text4 = createText(" \n\n        ");
				table._fragment.c();
				addLoc(h4, file$d, 9, 20, 329);
				div0.className = "modal-content";
				addLoc(div0, file$d, 8, 16, 281);
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$d, 18, 20, 753);
				div1.className = "modal-footer";
				addLoc(div1, file$d, 17, 16, 706);
				div2.id = "modaldelete";
				div2.className = "modal";
				addLoc(div2, file$d, 7, 12, 228);
			},
			...
			p: function update(changed, ctx) {
				if ((!current || changed.crudindex) && text0_value !== (text0_value = ctx.crudindex===0 ? "Confirm Delete" : "")) {
				...
				if ((!current || changed.crudindex) && text3_value !== (text3_value = ctx.crudindex===0 ? "Delete" : "")) {
					setData(text3, text3_value);
				}

				var table_changes = {};
				if (changed.getform) table_changes.content = ctx.infos;
				table._set(table_changes);
			},
	...
	// (12:24) {#if crudindex === 0}
	function create_if_block$7(component, ctx) {
		var if_block_anchor;

		var if_block = (ctx.objModal) && create_if_block_1$4(component, ctx);
	...
	function create_if_block_1$4(component, ctx) {
		var p, text0, strong, text1, text2_value = ctx.objModal.id, text2, text3;

		return {
			c: function create() {
				p = createElement("p");
				text0 = createText("Do you really want to delete the info ");
				strong = createElement("strong");
				text1 = createText("#");
				text2 = createText(text2_value);
				text3 = createText(" ?");
				addLoc(strong, file$d, 13, 73, 565);
				addLoc(p, file$d, 13, 32, 524);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.objModal) && text2_value !== (text2_value = ctx.objModal.id)) {
	...
	function FreeConsultationForm(options) {
		this._debugName = '<FreeConsultationForm>';
		if (!options || (!options.target && !options.root)) {
			throw new Error("'target' is a required option");
		}
		...
		if (!('getform' in this._state)) console.warn("<FreeConsultationForm> was created without expected data property 'getform'");
		if (!('crudindex' in this._state)) console.warn("<FreeConsultationForm> was created without expected data property 'crudindex'");
		if (!('objModal' in this._state)) console.warn("<FreeConsultationForm> was created without expected data property 'objModal'");
		this._intro = !!options.intro;
	...
	assign(FreeConsultationForm.prototype, protoDev);
	assign(FreeConsultationForm.prototype, methods$7);

	FreeConsultationForm.prototype._checkReadOnly = function _checkReadOnly(newState) {
	};
	...
	const file$f = "ui/panel/admin_pages/CommentControlCenter.html";
	...
	function create_then_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				text4 = createText(" \n\n        ");
				table._fragment.c();
				addLoc(h4, file$f, 10, 20, 452);
				div0.className = "modal-content";
				addLoc(div0, file$f, 9, 16, 404);
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$f, 42, 20, 2678);
				div1.className = "modal-footer";
				addLoc(div1, file$f, 41, 16, 2631);
	...
	function create_else_block$4(component, ctx) {
		...
		var if_block = (ctx.objModal) && create_if_block_3$1(component, ctx);
	...
	function create_if_block_2$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				text3 = createText(text3_value);
				text4 = createText(" ?");
				addLoc(h4, file$f, 21, 28, 1007);
				addLoc(p, file$f, 22, 28, 1060);
			},
	...
	function create_if_block_1$5(component, ctx) {
		...
		return {
			c: function create() {
				...
				text3 = createText(text3_value);
				text4 = createText(" ?");
				addLoc(h4, file$f, 17, 28, 813);
				addLoc(p, file$f, 18, 28, 864);
			},
	...
	function create_if_block$8(component, ctx) {
		...
		return {
			c: function create() {
				...
				text3 = createText(text3_value);
				text4 = createText(" ?");
				addLoc(h4, file$f, 13, 28, 617);
				addLoc(p, file$f, 14, 28, 669);
			},
	...
	function create_if_block_3$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(a, file$f, 28, 38, 1395);
				textarea.id = "content";
				textarea.className = "materialize-textarea";
				textarea.value = textarea_value_value = ctx.crudindex === 1 ? ctx.objModal.content : "";
				addLoc(textarea, file$f, 34, 40, 2262);
				label.htmlFor = "content";
				addLoc(label, file$f, 35, 40, 2408);
			},
	...
	assign(CommentControlCenter.prototype, methods$8);
	...
	/* ui/tags/Editor.html generated by Svelte v2.16.1 */
	...
	const file$i = "ui/tags/Editor.html";
	...
	function create_main_fragment$i(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$i, 0, 0, 0);
				div1.id = ctx.id;
				addLoc(div1, file$i, 2, 0, 41);
			},
	...
	/* ui/tags/Select.html generated by Svelte v2.16.1 */
	...
	const file$j = "ui/tags/Select.html";
	...
	function create_main_fragment$j(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(option, file$j, 2, 8, 54);
				addListener(select, "change", change_handler);
				select.id = ctx.id;
				addLoc(select, file$j, 1, 4, 10);
				addLoc(label, file$j, 7, 4, 235);
	...
	assign(Select.prototype, methods$9);
	...
	function create_main_fragment$k(component, ctx) {
		...
		return {
			c: function create() {
				...
				info_1.block.c();
				addLoc(span0, file$k, 5, 20, 194);
				input0.id = "cover";
				setAttribute(input0, "type", "file");
				addLoc(input0, file$k, 6, 20, 232);
				div0.className = "btn waves-effect waves-light yellow black-text";
				addLoc(div0, file$k, 4, 16, 113);
				input1.disabled = true;
				input1.placeholder = "Pick a cover";
				input1.className = "file-path validate";
				setAttribute(input1, "type", "text");
				addLoc(input1, file$k, 9, 20, 354);
				div1.className = "file-path-wrapper";
				addLoc(div1, file$k, 8, 16, 302);
				div2.className = "file-field input-field";
				addLoc(div2, file$k, 3, 12, 60);
				label0.htmlFor = "description";
				addLoc(label0, file$k, 14, 12, 662);
				addLoc(br0, file$k, 15, 12, 727);
				div3.className = "divider";
				addLoc(div3, file$k, 15, 16, 731);
				addLoc(br1, file$k, 15, 43, 758);
				label1.htmlFor = "description";
				addLoc(label1, file$k, 18, 12, 949);
				input4.placeholder = "+Tag";
				input4.className = "custom-class";
				input4.id = "tags";
				addLoc(input4, file$k, 20, 20, 1054);
				div4.className = "chips";
				addLoc(div4, file$k, 19, 12, 1014);
				setAttribute(input5, "type", "checkbox");
				input5.id = "telegram";
				addLoc(input5, file$k, 23, 16, 1171);
				addLoc(span1, file$k, 24, 16, 1227);
				addLoc(label2, file$k, 22, 12, 1147);
				setAttribute(input6, "type", "checkbox");
				input6.id = "comments";
				addLoc(input6, file$k, 27, 16, 1314);
				addLoc(span2, file$k, 28, 16, 1369);
				addLoc(label3, file$k, 26, 12, 1290);
				form.id = "post";
				addLoc(form, file$k, 2, 9, 31);
				div5.className = "row";
				addLoc(div5, file$k, 0, 0, 0);
				addLoc(br2, file$k, 44, 0, 2041);
				div6.className = "divider";
				addLoc(div6, file$k, 44, 4, 2045);
				addLoc(br3, file$k, 44, 32, 2073);
				div7.className = "row";
				addLoc(div7, file$k, 45, 0, 2078);
			},
	...
	function create_if_block_1$6(component, ctx) {
		...
		return {
			c: function create() {
				...
				addListener(a0, "click", click_handler);
				a0.className = "waves-effect waves-light yellow black-text btn";
				addLoc(a0, file$k, 38, 8, 1730);
				addListener(a1, "click", click_handler_1);
				a1.className = "waves-effect waves-light blue-grey darken-4 btn";
				addLoc(a1, file$k, 39, 8, 1821);
			},
	...
	function create_then_block$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				div = createElement("div");
				if (if_block) if_block.c();
				addLoc(h5, file$k, 50, 12, 2192);
				addLoc(div, file$k, 52, 12, 2335);
			},
	...
	function create_if_block$9(component, ctx) {
		...
		return {
			c: function create() {
				...
				info.block.c();
				addLoc(br, file$k, 69, 16, 3196);
				addLoc(h5, file$k, 70, 16, 3217);
			},
			...
			p: function update(changed, _ctx) {
				ctx = _ctx;
				var table_changes = {};
				if (changed.utils || changed.editPage) table_changes.actions = [
	                    {icon: "delete", tooltip: "delete", action(page, table) {
	                        ctx.utils.fetch(`/page/${page.id}/route/remove`, {})
	                        .then(r=>{
	                            if(r.status == 200) {
	...
	// (81:19)                      <Loading small/>                 {:then pages}
	...
	// (48:26)              <Loading small/>         {:then routes}
	...
	function ContentControlCenter(options) {
		...
		if (!('editPage' in this._state)) console.warn("<ContentControlCenter> was created without expected data property 'editPage'");
	...
	function create_then_block$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				i._fragment.c();
				addLoc(h4, file$l, 12, 20, 469);
				div0.className = "modal-content";
				addLoc(div0, file$l, 11, 16, 421);
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$l, 36, 20, 2038);
				div1.className = "modal-footer";
				addLoc(div1, file$l, 35, 16, 1991);
				div2.id = div2_id_value = ctx.crudindex===1 ? "modaledit" :  ctx.crudindex===0 ? "modalcreate" : ctx.crudindex===4 ? "modalblock" : ctx.crudindex===5 ? "modalunblock" : "modaldelete";
				div2.className = "modal bottom-sheet";
				addLoc(div2, file$l, 10, 12, 224);
				addListener(a, "click", click_handler_1);
				a.className = "btn-floating btn-large waves-effect waves-light red";
				addLoc(a, file$l, 78, 14, 4728);
				div3.className = "fixed-action-btn";
				addLoc(div3, file$l, 77, 8, 4683);
			},
	...
	function create_if_block_1$7(component, ctx) {
		...
		var if_block = (ctx.objModal) && create_if_block_2$2(component, ctx);
	...
	function create_if_block$a(component, ctx) {
		...
		return {
			c: function create() {
				...
				text3 = createText(text3_value);
				text4 = createText(" ?");
				addLoc(h4, file$l, 15, 28, 634);
				addLoc(strong, file$l, 16, 83, 741);
				addLoc(p, file$l, 16, 28, 686);
			},
	...
	function create_then_block$5(component, ctx) {
		...
		return {
			c: function create() {
				...
				text6 = createText("add");
				i._fragment.c();
				addLoc(h4, file$m, 10, 20, 446);
				div0.className = "modal-content";
				addLoc(div0, file$m, 9, 16, 398);
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$m, 69, 20, 5628);
				div1.className = "modal-footer";
				addLoc(div1, file$m, 68, 16, 5581);
				div2.id = div2_id_value = ctx.crudindex===1 ? "modaledit" :  ctx.crudindex===0 ? "modalcreate" : ctx.crudindex===4 ? "modalblock" : ctx.crudindex===5 ? "modalunblock" : "modaldelete";
				div2.className = "modal";
				addLoc(div2, file$m, 8, 12, 214);
				addListener(a, "click", click_handler_1);
				a.className = "btn-floating btn-large waves-effect waves-light red";
				addLoc(a, file$m, 120, 14, 8740);
				div3.className = "fixed-action-btn";
				addLoc(div3, file$m, 119, 8, 8695);
			},
	...
	function create_if_block_2$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				text3 = createText(text3_value);
				text4 = createText(" ?");
				addLoc(h4, file$m, 21, 28, 1061);
				addLoc(strong, file$m, 22, 80, 1166);
				addLoc(p, file$m, 22, 28, 1114);
			},
	...
	function create_if_block_1$8(component, ctx) {
		...
		return {
			c: function create() {
				...
				text3 = createText(text3_value);
				text4 = createText(" ?");
				addLoc(h4, file$m, 17, 28, 837);
				addLoc(strong, file$m, 18, 78, 938);
				addLoc(p, file$m, 18, 28, 888);
			},
	...
	function create_if_block$b(component, ctx) {
		...
		return {
			c: function create() {
				...
				text3 = createText(text3_value);
				text4 = createText(" ?");
				addLoc(h4, file$m, 13, 28, 611);
				addLoc(strong, file$m, 14, 79, 714);
				addLoc(p, file$m, 14, 28, 663);
			},
	...
	function create_then_block_1$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(label, file$m, 62, 40, 5330);
			},
	...
	function create_if_block_4$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				label.textContent = "description";
				label.htmlFor = "description";
				addLoc(label, file$m, 44, 40, 3948);
			},
	...
	function create_then_block$6(component, ctx) {
		...
		return {
			c: function create() {
				...
				text4 = createText(" \n\n        ");
				table._fragment.c();
				addLoc(h4, file$n, 10, 20, 305);
				div0.className = "modal-content";
				addLoc(div0, file$n, 9, 16, 257);
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$n, 16, 20, 563);
				div1.className = "modal-footer";
				addLoc(div1, file$n, 15, 16, 516);
				div2.id = "modalshow";
				div2.className = "modal";
				addLoc(div2, file$n, 8, 12, 206);
			},
	...
	function create_then_block$7(component, ctx) {
		...
		return {
			c: function create() {
				...
				text4 = createText(" \n\n        ");
				table._fragment.c();
				addLoc(h4, file$o, 10, 20, 312);
				div0.className = "modal-content";
				addLoc(div0, file$o, 9, 16, 264);
				addListener(button, "click", click_handler);
				button.className = "modal-close waves-effect waves-green btn-flat";
				addLoc(button, file$o, 30, 20, 1121);
				div1.className = "modal-footer";
				addLoc(div1, file$o, 29, 16, 1074);
				div2.id = "modalshow";
				div2.className = "modal";
				addLoc(div2, file$o, 8, 12, 213);
			},
	...
	function create_if_block$d(component, ctx) {
		...
		return {
			c: function create() {
				...
				i = createElement("i");
				i.textContent = "send";
				addLoc(div0, file$o, 14, 32, 461);
				addLoc(div1, file$o, 16, 32, 560);
				addLoc(div2, file$o, 18, 32, 659);
				i.className = "material-icons left";
				addLoc(i, file$o, 24, 32, 914);
				addListener(a, "click", click_handler);
				a.className = "btn waves-effect waves-light black-text yellow";
				addLoc(a, file$o, 22, 28, 756);
			},
	...
	// (4:24)          <Loading small/>     {:then freetimes}
	...
	function create_main_fragment$q(component, ctx) {
		...
		return {
			c: function create() {
				...
				card2._fragment.c();
				addLoc(h40, file$q, 2, 2, 86);
				span0.className = "red-text";
				addLoc(span0, file$q, 5, 5, 156);
				addLoc(h41, file$q, 7, 3, 322);
				span1.className = "red-text";
				addLoc(span1, file$q, 8, 39, 374);
				addLoc(p0, file$q, 8, 3, 338);
				addLoc(p1, file$q, 9, 4, 548);
				addListener(button0, "click", click_handler);
				button0.className = "btn white red-text waves-effect waves-gray";
				addLoc(button0, file$q, 11, 2, 581);
				addLoc(p2, file$q, 5, 2, 153);
				div0.className = "row";
				addLoc(div0, file$q, 0, 0, 0);
				addLoc(h42, file$q, 16, 2, 753);
				span2.className = "red-text";
				addLoc(span2, file$q, 17, 5, 776);
				addLoc(br, file$q, 17, 107, 878);
				addLoc(p3, file$q, 17, 2, 773);
				addListener(button1, "click", click_handler_1);
				button1.className = "btn waves-effect waves-light yellow black-text col s4";
				addLoc(button1, file$q, 24, 3, 1299);
				div1.className = "row";
				addLoc(div1, file$q, 14, 0, 688);
				span3.className = "red-text";
				addLoc(span3, file$q, 30, 6, 1508);
				addLoc(h43, file$q, 30, 2, 1504);
				addLoc(span4, file$q, 33, 4, 1702);
				input5.id = "avatarpicker";
				setAttribute(input5, "type", "file");
				addLoc(input5, file$q, 34, 4, 1738);
				div2.className = "btn waves-effect waves-light black-text yellow";
				addLoc(div2, file$q, 32, 3, 1637);
				input6.className = "file-path validate";
				setAttribute(input6, "type", "text");
				addLoc(input6, file$q, 37, 4, 1825);
				div3.className = "file-path-wrapper";
				addLoc(div3, file$q, 36, 3, 1789);
				div4.className = "file-field input-field";
				addLoc(div4, file$q, 31, 2, 1597);
				addListener(button2, "click", click_handler_2);
				button2.className = "btn waves-effect waves-light black-text yellow submit";
				addLoc(button2, file$q, 40, 8, 1899);
				div5.className = "row";
				addLoc(div5, file$q, 28, 0, 1439);
			},
	...
	/* ui/tags/Sidenav.html generated by Svelte v2.16.1 */
	...
	const file$r = "ui/tags/Sidenav.html";
	...
	function create_main_fragment$r(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(a0, file$r, 4, 7, 178);
				addLoc(li0, file$r, 4, 3, 174);
				ul0.id = "nav-mobile";
				ul0.className = "left hide-on-large-only yellow";
				addLoc(ul0, file$r, 3, 2, 111);
				div0.className = "nav-wrapper yellow";
				addLoc(div0, file$r, 2, 1, 76);
				nav.className = "hide-on-large-only white";
				addLoc(nav, file$r, 1, 0, 36);
				a1.dataset.target = "slide-out";
				a1.className = "sidenav-close hide-on-large-only";
				addLoc(a1, file$r, 19, 5, 592);
				addLoc(li1, file$r, 19, 1, 588);
				div1.className = "divider";
				addLoc(div1, file$r, 20, 5, 687);
				addLoc(li2, file$r, 20, 1, 683);
				addLoc(br0, file$r, 27, 1, 848);
				addLoc(br1, file$r, 27, 5, 852);
				addLoc(br2, file$r, 27, 9, 856);
				addLoc(br3, file$r, 27, 13, 860);
				ul1.id = "slide-out";
				ul1.className = ul1_class_value = "col s10 m5 l3 sidenav " + (ctx.fixed ? "sidenav-fixed" : "");
				addLoc(ul1, file$r, 8, 0, 303);
			},
	...
	function create_if_block$e(component, ctx) {
		...
		return {
			c: function create() {
				...
				img.width = "200";
				img.height = "200";
				addLoc(img, file$r, 13, 4, 466);
				div0.className = "background";
				addLoc(div0, file$r, 12, 3, 437);
				addLoc(br0, file$r, 15, 3, 547);
				addLoc(br1, file$r, 15, 7, 551);
				addLoc(br2, file$r, 15, 11, 555);
				addLoc(br3, file$r, 15, 15, 559);
				div1.className = "user-view";
				addLoc(div1, file$r, 11, 2, 410);
				addLoc(li, file$r, 10, 1, 403);
			},
	...
	function create_main_fragment$s(component, ctx) {
		...
		return {
			c: function create() {
				...
				div0.id = "workspace";
				addLoc(div0, file$s, 19, 2, 470);
				div1.className = "col offset-l3";
				addLoc(div1, file$s, 18, 1, 440);
				div2.className = "row";
				addLoc(div2, file$s, 4, 0, 54);
			},
	...
	function create_if_block$f(component, ctx) {
		...
		return {
			c: function create() {
				...
				a.href = "#!";
				addLoc(a, file$s, 11, 9, 270);
				addLoc(li, file$s, 11, 5, 266);
			},

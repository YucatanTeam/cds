	...
	function create_main_fragment$k(component, ctx) {
		...
		return {
			c: function create() {
				...
				info_1.block.c();
				addLoc(span0, file$k, 5, 20, 199);
				input0.id = "cover";
				setAttribute(input0, "type", "file");
				addLoc(input0, file$k, 6, 20, 238);
				...
				addLoc(input1, file$k, 9, 20, 363);
				div1.className = "file-path-wrapper";
				addLoc(div1, file$k, 8, 16, 310);
				div2.className = "file-field input-field";
				addLoc(div2, file$k, 3, 12, 63);
				label0.htmlFor = "description";
				addLoc(label0, file$k, 14, 12, 676);
				addLoc(br0, file$k, 15, 12, 742);
				div3.className = "divider";
				addLoc(div3, file$k, 15, 16, 746);
				addLoc(br1, file$k, 15, 43, 773);
				label1.htmlFor = "description";
				addLoc(label1, file$k, 18, 12, 967);
				input4.placeholder = "+Tag";
				input4.className = "custom-class";
				input4.id = "tags";
				addLoc(input4, file$k, 20, 20, 1074);
				div4.className = "chips";
				addLoc(div4, file$k, 19, 12, 1033);
				setAttribute(input5, "type", "checkbox");
				input5.id = "telegram";
				addLoc(input5, file$k, 23, 16, 1194);
				addLoc(span1, file$k, 24, 16, 1251);
				addLoc(label2, file$k, 22, 12, 1169);
				setAttribute(input6, "type", "checkbox");
				input6.id = "comments";
				addLoc(input6, file$k, 27, 16, 1341);
				addLoc(span2, file$k, 28, 16, 1397);
				addLoc(label3, file$k, 26, 12, 1316);
				form.id = "post";
				addLoc(form, file$k, 2, 9, 33);
				div5.className = "row";
				addLoc(div5, file$k, 0, 0, 0);
				addLoc(br2, file$k, 44, 0, 2085);
				div6.className = "divider";
				addLoc(div6, file$k, 44, 4, 2089);
				addLoc(br3, file$k, 44, 32, 2117);
				div7.className = "row";
				addLoc(div7, file$k, 45, 0, 2123);
			},
	...
	function create_then_block$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				div = createElement("div");
				if (if_block) if_block.c();
				addLoc(h5, file$k, 50, 12, 2242);
				addLoc(div, file$k, 52, 12, 2387);
			},
	...
	function create_if_block$9(component, ctx) {
		...
		return {
			c: function create() {
				...
				info.block.c();
				addLoc(br, file$k, 69, 16, 3265);
				addLoc(h5, file$k, 70, 16, 3287);
			},
